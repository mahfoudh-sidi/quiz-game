...
function getQuestions($quiz_file) {
    ...
    // Save both questions and correct answers in the session
    $_SESSION['questions'] = $questions;
    $_SESSION['correct_option_index'] = $correct_answers;
...
if (isset($_POST['select_quiz'])) {
    ...
    if ($selected_quiz === "Surprise Me!") {
        ...
        $_SESSION['questions'] = array_slice($all_questions, 0, 10);
        $_SESSION['quiz_title'] = "Surprise Me!";
    } elseif (isset($quiz_files[$selected_quiz])) {
        // Load questions for the selected quiz
        $_SESSION['questions'] = getQuestions($quiz_files[$selected_quiz]);
